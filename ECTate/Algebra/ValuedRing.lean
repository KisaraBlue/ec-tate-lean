        ...
        | succ d =>
          ...
          | ⟨q, hq⟩ =>
            ...
            simp only [←hq, (show c.succ * d.succ = (c * d + c + d).succ
              by simp [Nat.succ_mul, Nat.mul_succ, Nat.add_succ]), nat_valuation_add_two, nat_valuation_aux]
...
convert nat_val_aux'_mul_eq_add p prime prime.one_lt a b sorry sorry <;>
  sorry
