...
--     (I n, 1, c, (u, r, s, t))
--   else
--   have hb2 : evr.valtn e.b2 ≥ ofN 1 := le_of_not_lt test_b2
...
--   have h3 : evr.valtn e'.a3 ≥ ofN 1 := by
...
--   have h4 : evr.valtn e'.a4 ≥ ofN 1 := by
--     delta Model.is_local_singular_point at sing_origin
...
--   have h6 : evr.valtn e'.a6 ≥ ofN 1 := by
--     delta Model.is_local_singular_point at sing_origin
...
--   --have hb2 : evr.valtn e.b2 ≥ ofN 1 := sorry --adapt test_b2 after change of coordinates

--   if test_a6 : evr.valtn e'.a6 < ofN 2 then (II, n, 1, (u, r, s, t)) else
--   have h6 : evr.valtn e'.a6 ≥ ofN 2 := le_of_not_lt test_a6

--   if test_b8 : evr.valtn e'.b8 < ofN 3 then (III, n-1, 2, (u, r, s, t)) else
--   have hb8 : evr.valtn e'.b8 ≥ ofN 3 := le_of_not_lt test_b8

--   if test_b6 : evr.valtn e'.b6 < ofN 3 then
--     let (a3p, a6p2) := (evr.sub_val e'.a3 1, evr.sub_val e'.a6 2)
--     let c := if evr.quad_roots_in_residue_field 1 a3p (-a6p2) then 3 else 1
--     (IV, n - 2, c, (u, r, s, t))
--   else
--   have hb6 : evr.valtn e'.b6 ≥ ofN 3 := le_of_not_lt test_b6

--   have hb2 : evr.valtn e'.b2 ≥ ofN 1 := by
...
--   --let k := if evr.valtn e.a6 < ofN 3 then if p = 2 then 2 else evr.norm_repr e.a3 9 else 0
--   have hdr_b2 : evr.has_double_root 1 e'.a1 (-e'.a2) := by
--     apply And.intro (val_of_one evr.valtn) _
--     apply lt_of_succ_le
--     rw [mul_one, ←neg_mul_eq_mul_neg, sub_eq_add_neg, neg_neg (4 * e'.toModel.a2), succ_ofN, pow_succ, pow_one]
--     assumption
...
--     apply And.intro (val_of_one evr.valtn) _
--     apply lt_of_succ_le
--     rw [mul_one, ←neg_mul_eq_mul_neg, sub_eq_add_neg, neg_neg (4 * a6p2), succ_ofN, pow_succ, pow_one]
...
--   have h3 : evr.valtn e''.a3 ≥ ofN 2 := by
--     rw [st_of_a1, add_comm e'.a1, ←succ_ofN, ←mul_one 2]
--     exact succ_le_of_lt (val_poly_of_double_root hp 1 e'.a1 (-e'.a2) hdr_b2).2
--     sorry -- = d/dt (t - pi*beta)²
--   have h4 : evr.valtn e''.a4 ≥ ofN 2 := sorry -- using pi³|b_8
--   have h6 : evr.valtn e''.a6 ≥ ofN 3 := sorry -- = -(t - pi*beta)²
...
--     let r := r + u^2 * r1
--     let t := t + u ^ 2 * s * r1
--     have h1 : evr.valtn e.a1 ≥ ofN 1 := sorry -- preserved
--     have h2 : evr.valtn e.a2 = ofN 1 := sorry -- T=0 double root => a_2,1 /= 0
--     have h3 : evr.valtn e.a3 ≥ ofN 2 := sorry -- preserved
--     have h4 : evr.valtn e.a4 ≥ ofN 3 := sorry -- T=0 double root => a_4,2 = 0
--     have h6 : evr.valtn e.a6 ≥ ofN 4 := sorry -- T=0 double root => a_6,3 = 0
...
--   let r := r + u ^ 2 * r1
--   let t := t + u ^ 2 * s * r1
--   have h2 : evr.valtn e.a2 ≥ ofN 2 := sorry -- T=0 triple root => a_2,1 = 0
--   have h3 : evr.valtn e.a3 ≥ ofN 2 := sorry -- preserved
--   --have h4 : evr.valtn e.a4 ≥ ofN 3 := sorry
--   have h6 : evr.valtn e.a6 ≥ ofN 4 := sorry -- T=0 triple root => a_6,3 = 0
...
--   let t := t + k * u ^ 3
--   have h3 : evr.valtn e.a3 ≥ ofN 3 := sorry --change of coord using root
--   --have h6 : evr.valtn e.a6 ≥ ofN 5 := sorry

--   if test_a4 : evr.valtn e.a4 < ofN 4 then (IIIs, n - 7, 2, (u, r, s, t)) else
--   have h4 : evr.valtn e.a4 ≥ ofN 4 := le_of_not_lt test_a4

--   if test_a6 : evr.valtn e.a6 < ofN 6 then (IIs, n - 8, 1, (u, r, s, t)) else
--   have h6 : evr.valtn e.a6 ≥ ofN 6 := le_of_not_lt test_a6

--   have h1 : evr.valtn e.a1 ≥ ofN 1 := sorry --preserved
--   have h2 : evr.valtn e.a2 ≥ ofN 2 := sorry --preserved
